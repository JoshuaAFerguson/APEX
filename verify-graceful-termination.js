...
function analyzeTestFile(filePath) {
  ...
  return {
    ...
    gracefulTermination: content.includes('In-flight requests terminated gracefully') &&
                        ...
                        content.includes('method') && content.includes('graceful'),
...
function verifyMockImplementation(mockPath) {
...
function main() {
  ...
  console.log(`  Test file: ${fs.existsSync(testFilePath) ? '✅' : '❌'} ${path.basename(testFilePath)}`);
  console.log(`  Mock SDK: ${fs.existsSync(mockFilePath) ? '✅' : '❌'} ${path.basename(mockFilePath)}`);
  console.log(`  Mock types: ${fs.existsSync(mockTypesPath) ? '✅' : '❌'} ${path.basename(mockTypesPath)}`);
  console.log('');
