...
exports.directoryAccessValidator = exports.DirectoryAccessValidator = void 0;
...
class DirectoryAccessValidator {
     ...
     */
    isPathAllowed(filePath, config, options = {}) {
        try {
     ...
     */
    matchesAllowlist(filePath, patterns) {
     ...
     */
    matchesBlocklist(filePath, patterns) {
        if (!patterns || patterns.length === 0) {
            return false;
        }
        try {
     ...
     */
    normalizeAndValidatePath(filePath, baseDir) {
        if (typeof filePath !== 'string' || !filePath.trim()) {
            throw new Error('File path must be a non-empty string');
        }
        // Convert to absolute path if relative
        let absolutePath = node_path_1.default.isAbsolute(filePath)
            ? filePath
            : node_path_1.default.resolve(baseDir || process.cwd(), filePath);
        // Normalize the path
        absolutePath = (0, path_utils_js_1.normalizePath)(absolutePath);
    ...
    normalizePath(filePath) {
        return (0, path_utils_js_1.normalizePath)(filePath);
    }
    /**
    ...
    matchesPattern(filePath, pattern) {
        ...
        try {
            ...
            return (0, minimatch_1.minimatch)(filePath, normalizedPattern, {
...
exports.DirectoryAccessValidator = DirectoryAccessValidator;
// ============================================================================
 ...
 */
exports.directoryAccessValidator = new DirectoryAccessValidator();
/**
 ...
 */
function isPathAllowed(filePath, config, options) {
    return exports.directoryAccessValidator.isPathAllowed(filePath, config, options);
}
/**
 ...
 */
function matchesAllowlist(filePath, patterns) {
    return exports.directoryAccessValidator.matchesAllowlist(filePath, patterns);
}
/**
 ...
 */
function matchesBlocklist(filePath, patterns) {
    return exports.directoryAccessValidator.matchesBlocklist(filePath, patterns);
}
//# sourceMappingURL=directory-access-validator.js.map